// Title: Project 2: Mutexes
// Name: Bennett Hamilton
// Collaborators: Ashley Doerfler
// Date: 4/13/24
// Description: A C program using mutexes that allows brokers to reserve (and unreserve) seats at a venue.
...
int is_free(int n) {
    ...
    int status = !seat_taken[n];     // if status is 1, the seat is free
